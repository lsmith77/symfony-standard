...
namespace SevenManager\FixturesBundle\Controller;

use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use SevenManager\FixturesBundle\Document\Task;


/**
 * Class DefaultController
 *
 * @package SevenManager\FixturesBundle\Controller
 */
class DefaultController extends Controller
{
    ...
    {
        return $this->render('SevenManagerFixturesBundle:Default:index.html.twig', array('name' => $name));
    }
